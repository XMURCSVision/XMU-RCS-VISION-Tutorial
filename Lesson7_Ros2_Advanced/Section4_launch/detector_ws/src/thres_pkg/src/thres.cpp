...
namespace thres
{
    ImgNode::ImgNode(const rclcpp::NodeOptions &options) : Node("image_node", options)
    {

        // 图像resize
        cv::resize(this->img_bgr_ori, this->img_bgr, (600, 480));
...
RCLCPP_COMPONENTS_REGISTER_NODE(thres::ImgNode)