...
public:
  ...
  struct ArmorParams  //装甲板参数  //这是等电控发吗？
  {
    double min_light_ratio;
    // light pairs distance
    double min_small_center_distance;  //??小装甲板
    double max_small_center_distance;
    double min_large_center_distance;  //??大装甲板
    double max_large_center_distance;
    // horizontal angle
    double max_angle;
  };

  //Detector类的构造函数，传入阈值、颜色、LightParams型数据、ArmorParams型数据
